...
| -------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------ |
| `container_cpu_usage_seconds_total` (pod vmalert)  | **Риск:** замедление eval и рост задержек алертов. **Что делать:** добавить CPU/реплики (или шарды), упростить тяжёлые правила.                                                                                                                                            | **~5,2 m** CPU на 1000 `ALERTS` |
| `container_memory_working_set_bytes` (pod vmalert) | **Риск:** OOMKill и пауза в оценке правил. **Что делать:** поднять лимит памяти с запасом и шардировать vmalert при росте.                                                                                                                                                 | **~14,1 MiB** на 1000 `ALERTS`   |
